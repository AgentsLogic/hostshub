...
export default function PricingPage() {
  ...
  return (
    <DashboardShell>
      ...
      <Tabs defaultValue="monthly" className="w-full px-4 md:px-6">
        ...
        <TabsContent value="monthly">
          <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 lg:gap-8 mt-6">
            {plans.monthly.map((plan) => (
              <Card key={plan.name} className={`bg-gradient-to-br from-blue-100 via-white to-blue-100 ${plan.popular ? "border-primary shadow-lg" : ""}`}>
                <CardHeader>
