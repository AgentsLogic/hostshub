      ...
      <section id="details" className="max-w-5xl mx-auto px-6 py-16 space-y-12">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-6">
            {[
              { name: "Airbnb", logo: "/placeholder.jpg", link: "#" },
              { name: "VRBO", logo: "/placeholder.jpg", link: "#" },
              { name: "Booking.com", logo: "/placeholder.jpg", link: "#" },
            ].map((platform) => (
              <a
                key={platform.name}
                href={platform.link}
                className="flex flex-col items-center justify-center w-28 h-28 rounded-lg shadow hover:scale-105 transition-transform duration-300 border border-gray-200 p-3 bg-white"
              >
                <img src={platform.logo} alt={platform.name} className="w-12 h-12 object-contain mb-2" />
