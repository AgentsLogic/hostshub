...
import { Users, Bed, Bath, Coffee, Wifi, Car, Tv, Snowflake } from "lucide-react"
...
export function LuxuryTemplate({ property }: LuxuryTemplateProps) {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-black/90 backdrop-blur">
        <div className="container flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex gap-6">
            ...
            <a href="#amenities" className="text-sm font-medium hover:text-primary">
              Amenities
            </a>
            <a href="#location" className="text-sm font-medium hover:text-primary">
              Location
            </a>
      ...
      <div className="relative h-[80vh] w-full">
        ...
        <img
          src={images[0] || "/placeholder.svg?height=1080&width=1920"}
          alt={property.name}
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center">
          <div className="container text-center">
            ...
            <p className="text-xl md:text-2xl max-w-2xl mx-auto">{property.location}</p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <div id="overview" className="space-y-6">
              <h2 className="text-3xl font-bold border-b border-white/10 pb-4">About this property</h2>
              <div className="flex flex-wrap gap-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-lg">Up to {property.bedrooms * 2} guests</span>
                </div>
              </div>

              <p className="text-lg text-white/80">{property.description || "No description provided."}</p>
            </div>

            {/* Gallery */}
            <div className="space-y-6">
              <h2 className="text-3xl font-bold border-b border-white/10 pb-4">Gallery</h2>
            ...
            <div id="amenities" className="space-y-6">
              <h2 className="text-3xl font-bold border-b border-white/10 pb-4">Luxury Amenities</h2>
            ...
            <div id="location" className="space-y-6">
              <h2 className="text-3xl font-bold border-b border-white/10 pb-4">Location</h2>
              ...
              <p className="text-lg text-white/80">
                Located in {property.location}, this property offers easy access to beaches, restaurants, and local
                attractions.
              </p>
            </div>
            ...
            <div id="reviews" className="space-y-6">
              <h2 className="text-3xl font-bold border-b border-white/10 pb-4">Guest Reviews</h2>
              <div className="space-y-6">
                {[1, 2, 3].map((review) => (
                  <div key={review} className="bg-white/5 rounded-lg p-6">
                    ...
                    <p className="text-white/80">
                      "Absolutely stunning property with impeccable attention to detail. The host was incredibly
                      accommodating and the amenities were top-notch. I can't wait to return for another luxurious
                      stay."
                    </p>
                  </div>
                ))}
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-6 mb-6">
                    <div>
                      ...
                      <div className="flex items-center mt-2 bg-white/10 rounded-md p-2">
                        <Button
                          variant="ghost"
                          size="icon"
                        ...
                        <span className="mx-6 font-medium text-lg">{guests}</span>
                        <Button
                          variant="ghost"
                          size="icon"
                  ...
                  <div className="space-y-3 mb-6">
                    <div className="flex justify-between">
                      <span className="text-white/80">${property.price_per_night} x 7 nights</span>
                      <span>${property.price_per_night * 7}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-white/80">Cleaning fee</span>
                      <span>$150</span>
                    </div>
                    <div className="flex justify-between">
                  ...
                  <Button className="w-full mt-6 bg-primary hover:bg-primary/90 text-lg py-6">Reserve Now</Button>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <footer className="border-t border-white/10 mt-16 bg-black">
        <div className="container py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div>
              <h3 className="text-xl font-bold mb-6">Host</h3>
              <ul className="space-y-4 text-white/60">
                <li>
                  <a href="#" className="hover:text-primary">
                    Host your home
