...
import { PropertyGallery } from "@/app/templates/modern/components/property-gallery"
...
export function ModernTemplate({ property }: ModernTemplateProps) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <div className="flex items-center mt-2">
                <div className="flex items-center">
                  ...
                  <span className="underline">24 reviews</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h2 className="text-xl font-semibold">Hosted by Sarah Johnson</h2>
              <div className="flex items-center gap-4">
                <div className="h-16 w-16 rounded-full overflow-hidden">
                  <img src="/placeholder.svg?height=100&width=100" alt="Host" className="w-full h-full object-cover" />
                </div>
                <div>
                  <p className="font-medium">Response rate: 100%</p>
                  <p className="text-muted-foreground">Response time: within an hour</p>
                </div>
              </div>
            </div>
